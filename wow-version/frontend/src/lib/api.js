...
export const analyzeJD = (jd) => api.post('/analyze-jd', { jd_text: jd })
export const generateQuestions = (resume, analysis) => api.post('/generate-questions', { resume_text: resume, jd_analysis: analysis })
export const optimizeResume = (resume, analysis, answers, selectedSkills = []) => api.post('/optimize', { resume_text: resume, jd_analysis: analysis, answers, selected_skills: selectedSkills })
